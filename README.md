...
이틀 연속 러닝을 쉬면, 벌칙 하나. 항목과 확률을 직접 정하는 미니멀한 뽑기 앱입니다.

[bbob — 러닝 약속](https://bbkk-ivory.vercel.app/)

기본 벌칙은 청소 20분, 설거지 전담, 친구에게 커피 사기, 배달 대신 직접 요리, 미뤄둔 일 30분이며 각각 20%입니다. 러닝 여부는 직접 판단하며 운동 기록이나 달력 기능은 제공하지 않습니다.
